								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637dc754c4c6f">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637dc754c4c6f" data-allow-clear="true">
																<option></option>
											...
											<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
												...
												<ul class="nav flex-wrap border-transparent fw-bold">
													...
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo1/dist/apps/support-center/overview.html">Overview</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="../../demo1/dist/apps/support-center/tickets/list.html">tickets</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo1/dist/apps/support-center/tutorials/list.html">Tutorials</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo1/dist/apps/support-center/faq.html">FAQ</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo1/dist/apps/support-center/licenses.html">Licenses</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo1/dist/apps/support-center/contact.html">Contact US</a>
													</li>
													<!--end::Nav item-->
												</ul>
												<!--end::Nav-->
																...
																<div class="mb-10">
																	...
																	<div class="highlight">
																		...
																		<ul class="nav nav-pills" role="tablist">
																			<li class="nav-item">
																				<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_637dc754c76f0" role="tab">JAVASCRIPT</a>
																			</li>
																			<li class="nav-item">
																				<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_637dc754c76f8" role="tab">HTML</a>
																			</li>
																		</ul>
																		<div class="tab-content">
																			<div class="tab-pane fade show active" id="kt_highlight_637dc754c76f0" role="tabpanel">
...
setTimeout(function() {
    button.removeAttribute(&quot;data-kt-indicator&quot;);
																			...
																			<div class="tab-pane fade" id="kt_highlight_637dc754c76f8" role="tabpanel">
																				<div class="highlight-code">
...
&lt;/button&gt;</code>
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Sandra Piquet</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Bob Clarcson</a>
																						<!--end::Username-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Matthew</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Boris</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
		...
		<script src="assets/js/custom/support-center/general.js"></script>
