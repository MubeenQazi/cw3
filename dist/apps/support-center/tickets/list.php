                          ...
                          <div class="mb-10">
                            ...
                            <div>
                              <select
                                ...
                                data-dropdown-parent="#kt_menu_637dc751ef0f4"
                ...
                >
                  ...
                  <div class="card mb-12">
                    ...
                    <div class="card-body flex-column p-5">
                      <!--begin::Hero content-->
                      <div
                        class="d-flex align-items-center h-lg-300px p-5 p-lg-15"
                      >
                        <!--begin::Wrapper-->
                        <div
                        ...
                        >
                          <!--begin::Title-->
                          <h1
                            class="fw-bold fs-4 fs-lg-1 text-gray-800 mb-5 mb-lg-10"
                          >
                            How Can We Help You?
                          </h1>
                          <!--end::Title-->
                      ...
                      <!--begin::Hero nav-->
                      <div
                        class="card-rounded bg-light d-flex flex-stack flex-wrap p-5"
                      >
                        <!--begin::Nav-->
                        <ul class="nav flex-wrap border-transparent fw-bold">
                          ...
                          <li class="nav-item my-1">
                            <a
                              class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active"
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-column flex-xl-row p-7">
                          ...
                          <div class="mb-0">
                            ...
                            <div class="mb-10">
                              ...
                              <div class="d-flex mb-10">
                                ...
                                <span
                                  class="svg-icon svg-icon-2x me-5 ms-n1 mt-2 svg-icon-success"
                                >
                                  <svg
                                    width="24"
                                    height="24"
                                ...
                                <div class="d-flex flex-column">
                                  ...
                                  <div class="d-flex align-items-center mb-2">
                                    ...
                                    <a
                                      ...
                                      >How to use Netronic with Django
                                      Framework?</a
                                    >
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light my-1"
                                      >React</span
                                    >
                                    <!--end::Label-->
                                  </div>
                                  ...
                                  <span class="text-muted fw-semibold fs-6"
                                    >By Keenthemes to save tons and more to time
                              ...
                              <div class="d-flex mb-10">
                                ...
                                <span
                                  class="svg-icon svg-icon-2x me-5 ms-n1 mt-2 svg-icon-warning"
                                >
                                  <svg
                                    width="24"
                                    height="24"
                                ...
                                <div class="d-flex flex-column">
                                  ...
                                  <div class="d-flex align-items-center mb-2">
                                    ...
                                    <a
                                      href="../../demo1/dist/apps/support-center/tickets/view.html"
                                      class="text-dark text-hover-primary fs-4 me-3 fw-semibold"
                                      >Admin theme authentication to node.js /
                                      strapi backend</a
                                    >
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                ...
                                <div class="d-flex flex-column">
                                  ...
                                  <div class="d-flex align-items-center mb-2">
                                    ...
                                    <a
                                      href="../../demo1/dist/apps/support-center/tickets/view.html"
                                      class="text-dark text-hover-primary fs-4 me-3 fw-semibold"
                                      >How to use Admin theme with Django
                                      Framework?</a
                                    >
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                ...
                                <div class="d-flex flex-column">
                                  ...
                                  <div class="d-flex align-items-center mb-2">
                                    ...
                                    <a
                                      href="../../demo1/dist/apps/support-center/tickets/view.html"
                                      class="text-dark text-hover-primary fs-4 me-3 fw-semibold"
                                      >Reducing footprint of Start theme</a
                                    >
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light my-1"
                                ...
                                <div class="d-flex flex-column">
                                  ...
                                  <div class="d-flex align-items-center mb-2">
                                    ...
                                    <a
                                      href="../../demo1/dist/apps/support-center/tickets/view.html"
                                      class="text-dark text-hover-primary fs-4 me-3 fw-semibold"
                                      >Admin theme node.js / strapi backend</a
                                    >
                                    <!--end::Title-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light my-1"
                        ...
                        >
                          <!--begin::More channels-->
                          <div
                            class="card-rounded bg-primary bg-opacity-5 p-10 mb-15"
                          >
                            <!--begin::Title-->
                            ...
                            <div class="d-flex align-items-center mb-10">
                              <!--begin::Icon-->
                              <i
                                class="bi bi-file-earmark-text text-primary fs-1 me-5"
                              ></i>
                              <!--end::SymIconbol-->
                              <!--begin::Info-->
                              <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-10">
                              <!--begin::Icon-->
                              <i
                                class="bi bi-chat-square-text-fill text-primary fs-1 me-5"
                              ></i>
                              <!--end::SymIconbol-->
                              <!--begin::Info-->
                              <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-10">
                              <!--begin::Icon-->
                              <i
                                class="bi bi-twitter text-primary fs-1 me-5"
                              ></i>
                              <!--end::SymIconbol-->
                              <!--begin::Info-->
                              <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                              <!--begin::Icon-->
                              <i
                                class="bi bi-github text-primary fs-1 me-5"
                              ></i>
                              <!--end::SymIconbol-->
                              <!--begin::Info-->
                              <div class="d-flex flex-column">
                          ...
                          >
                            ...
                            <div class="d-flex align-items-center mb-6">
                              ...
                              <a
                                href="#"
                                class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0"
                                >Angular Admin</a
                              >
                              <!--end::Subtitle-->
                            </div>
                          ...
                          >
                            ...
                            <div class="fv-row mb-8">
                              ...
                              >
                                <!--begin::Message-->
                                <div
                                  class="dz-message needsclick align-items-center"
                                >
                                  <!--begin::Icon-->
