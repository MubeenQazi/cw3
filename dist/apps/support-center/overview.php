...
$activeAcc = 'support_center';
$activeMenu = 'sc_overview';
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637dc74f32802">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637dc74f32802" data-allow-clear="true">
															<option></option>
										...
										<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
											...
											<ul class="nav flex-wrap border-transparent fw-bold">
												...
												<li class="nav-item my-1">
													<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="../../demo1/dist/apps/support-center/overview.html">Overview</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item my-1">
													<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase" href="../../demo1/dist/apps/support-center/tickets/list.html">tickets</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<li class="nav-item my-1">
										...
										<div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
											...
											<div class="card-body p-10 p-lg-15">
												...
												<div class="d-flex flex-stack mb-7">
													...
													<div class="d-flex align-items-center">
														<!--begin::Link-->
														<a href="../../demo1/dist/apps/support-center/tutorials/list.html" class="text-primary fw-bold me-1">All Tutorials</a>
														<!--begin::Link-->
														<!--begin::Arrow-->
														<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
														<span class="svg-icon svg-icon-2 svg-icon-primary">
