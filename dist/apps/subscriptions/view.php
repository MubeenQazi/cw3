...
$activeAcc = 'subscription';
$activeMenu = 'subscription_detail';
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637dc7865fcf8">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637dc7865fcf8" data-allow-clear="true">
															<option></option>
														...
														<tbody>
															...
															<tr>
																...
																<td class="min-w-400px">Invoice
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">2538-1418</a>status has changed from
															...
															<tr>
																<!--begin::Event=-->
																<td class="min-w-400px">Invoice
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">9100-6995</a>has been
															...
															<tr>
																...
																<td class="min-w-400px">
																	...
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary">7525-3115</a>
																</td>
																<!--end::Event=-->
																<!--begin::Timestamp=-->
															...
															<tr>
																<!--begin::Event=-->
																<td class="min-w-400px">Invoice
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">1077-7330</a>status has changed from
															...
															<tr>
																...
																<td class="min-w-400px">
																	...
																	<a href="#" class="fw-bold text-gray-800 text-hover-primary">8500-2929</a>
																</td>
																<!--end::Event=-->
																<!--begin::Timestamp=-->
