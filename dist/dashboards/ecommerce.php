					...
					<div class="d-flex flex-column flex-column-fluid">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
							...
							<div id="kt_app_content_container" class="app-container container-xxl">
								<!--begin::Row-->
								<div class="row g-5 g-xl-10 mb-xl-18">
									<!--begin::Col-->
								...
								<div class="row gy-5 g-xl-10">
									<!--begin::Col-->
									<!-- <div class="col-xl-6 mb-xl-10 ecommerce-recent-orders">
											<!--begin::Table widget 2-->
									<div class="d-none card h-md-100">
										<!--begin::Header-->
							...
							<!--end::Row-->
							<!--begin::Row-->
							<div class="row gy-5 g-xl-10 ecommerce-stock-report d-none">
								<!--begin::Col-->
								<div class="col-xl-4">
									<!--begin::List widget 5-->
									<div class="card card-flush h-xl-100">
